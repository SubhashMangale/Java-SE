...
1.	Introduction of Java:- Java was developed by James Gosling, Patrick Naughton and Mike Sheridan at Sun microsystem in 1991.In 1991 initial name of Java was Oak
        but it was TM of another brand so it renamed as a Java in 1995.
...
3)	In Java, both compile time and run time error checking performed. Java mainly focuses on memory management and exception handling by introducing the feature 
        of automatic garbage collector.
        
4)	Java is platform independent. Here meaning is that in Java, we can make code in one machine and can run it on any other machine by using JDK. Why? In java 
...
6)	Multithreading in Java: Java program can do many tasks simultaneously. Benefit of multithreading is that it utilizes same memory to execute multiple threads 
        at the same time. E.g.: While typing some text, grammatical errors are checked along with our typing like in MS word.
